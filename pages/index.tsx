                ...
                <ol className="story mb-0">
                  <li>
                    ...
                    <div>
                      ...
                      <span className="small text-primary">March 1990</span>
                    </div>
                  </li>
                  <li>
                    <div className="story-icon bg-icon-primary">
                    ...
                    <div>
                      <h5 className="mb-0">First Date or something</h5>
                      <span className="small text-primary">March 19, 1990</span>
                    </div>
                  </li>
                  <li>
                    <div className="story-icon bg-icon-primary">
                    ...
                    <div>
                      <h5 className="mb-0">Other thing</h5>
                      <span className="small text-primary">March 19 1990</span>
                    </div>
                  </li>
                  <li>
                      ...
                      <span className="hover-effect-icon has-svg">
                        ...
                        >
                          <g>
                            <path
                              fill="#E25D5D"
                              d="M36.904,6.66L36.904,6.66C28.5329-1.7395,14.9401-1.8373,6.4502,6.4736
                            ...
                            <path
                              fill="#FFFFFF"
                              d="M44.695,28.8005c0-0.4883-0.3996-0.8879-0.8879-0.8879h-4.4394v-4.4394
            ...
            <div className="row justify-content-center">
              <div className="col">
                <div className=" mb-5 pb-5">
                  <h1 className="display-4 mb-0">Our Wedding Party</h1>
                  <p className="w-md-40 mb-0 mx-auto text-dark-gray opacity-8 ">
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-md-4 d-flex flex-column align-items-center">
                <div className=" px-5 mb-4 pb-4 ">
                  ...
                  <div className=" mt-4">
                    <h5 className="mb-0">Brent Mitton</h5>
